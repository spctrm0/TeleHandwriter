...
public class OscTargetAddr {
	...
	public static String	prefixConnectionSyn			= "Syn";
	public static String	prefixConnectionSynAck	= "SynAck";
	public static String	prefixConnectionAck			= "Ack";
	public static String	prefixDisconnect				= "Disconnect";

	private long		lastConnectionAttemptInUsec	= 0;
	private boolean	isConnected									= false;
	private boolean	isConnecting								= false;

	public static int connectionAttemptIntervalInMSec = 2000;
